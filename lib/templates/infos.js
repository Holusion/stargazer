...
module.exports = function createInfos(){
  const tmpl = document.createElement("template");
  tmpl.innerHTML = `
  <link rel="stylesheet" href="../node_modules/material-components-web/dist/material-components-web.css">
  <div style="overflow-y: scroll; height: calc(100vh - 110px);">
    <ul class="mdc-list mdc-list--two-line product-info">
      ...
      <li class="mdc-list-item">
        <span class="mdc-list-item-item__text">
          IP du produit :
          <span class="mdc-list-item__secondary-text">
            <slot name="ip">Aucune ip n'a été trouvé</slot>
          </span>
        </span>
      </li>
      <li class="mdc-list-item">
    ...
    <slot name="log">Pas de controller</slot>
  </div>
  `;
  return tmpl.content;
}
