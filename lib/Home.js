...
class Home extends HTMLElement{
  ...
  <div slot="content" style="overflow-y: scroll; height: calc(100vh - 64px)">
      ...
      ">
        ...
        <ul>
          ...
          <li>Le site <a style="color:var(--mdc-theme-secondary); font-weight: bold" href="http://holusion.com" onclick="externalLink()">Holusion.com</a> pour nous contacter</li>
