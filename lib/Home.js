...
class Home extends HTMLElement{
  ...
  <div slot="content">
      ...
      ">
        ...
        <ul>
          <li>La <a style="color:var(--mdc-theme-secondary); font-weight: bold" href="https://github.com/Holusion/stargazer">documentation de Stargazer</a> pour le guide d'utilisation</li>
          <li>Le site <a style="color:var(--mdc-theme-secondary); font-weight: bold" href="http://holusion.com">Holusion.com</a> pour le nous contacter</li>
          <li>Le <a style="color:var(--mdc-theme-secondary); font-weight: bold" href="https://github.com/Holusion/stargazer/issues">bugtracker</a> pour nous remonter un bug</li>
        </ul>
      </div>
    </div>
    `
