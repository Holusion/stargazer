...
class FilterPanel extends HTMLElement {
  ...
  set visible(visible) {this.setAttribute('visible', visible)}
  ...
  addOption(name, slot, predicate) {
    ...
    checkbox.addEventListener("change", () => {
      checkbox.checked ? this.filterOption[name] = predicate : delete this.filterOption[name]
    })
